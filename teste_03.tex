...
To renderin pdf: quarto install tool tinytex On termninal
tinytex::install\_tinytex() On console
...
We present the results of exploratory data analysis in
Section~\ref{sec-eda} and the regression model in
...
\includegraphics{teste_03_files/figure-pdf/fig-histogram-1.pdf}
...
\includegraphics{teste_03_files/figure-pdf/fig-histogram-2.pdf}
